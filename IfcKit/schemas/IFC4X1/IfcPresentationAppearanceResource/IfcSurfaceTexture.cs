...
namespace BuildingSmart.IFC.IfcPresentationAppearanceResource
{
	...
	<br /> ")]
		public IfcBoolean RepeatS { get { return this._RepeatS; } set { this._RepeatS = value;} }
	...
	<br />")]
		public IfcBoolean RepeatT { get { return this._RepeatT; } set { this._RepeatT = value;} }
	
		[Description(@"The <em>Mode</em> attribute is provided to control the appearance of a multi textures. The mode then controls the type of blending operation. The mode includes a MODULATE for a lit appearance, a REPLACE for a unlit appearance, and variations of the two.
	...
	<blockquote class=""change-ifc2x4"">IFC4 CHANGE&nbsp; New attribute replacing previous TextureType.</blockquote>")]
		...
		[Description(@"The <em>Parameter</em> attribute is provided to control the appearance of a multi textures. The applicable parameters depend on the value of the <em>Mode</em> attribute.
	...
	By convention, <em>Parameter[1]</em> shall then hold the source value, <em>Parameter[2]</em> the function value, <em>Parameter[3]</em> the base RGB color for select operations, and <em>Parameter[4]</em> the alpha value for select operations.</blockquote>
	  <blockquote class=""change-ifc2x4"">IFC4 CHANGE&nbsp; New attribute added at the end of the attribute list.</blockquote>")]
		...
		[Description(@"Texture coordinates, either provided by a corresponding list of texture vertices to vertex-based geometric items or by a texture coordinate generator, that applies the surface texture to the surfaces of the geometric items.
	<blackquote class=""change-ifc2x4"">
	IFC4 CHANGE&nbsp; New attribute added at the end of the attribute list.</blockquote>")]
