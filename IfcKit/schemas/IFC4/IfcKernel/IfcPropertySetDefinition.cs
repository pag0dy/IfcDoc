...
namespace BuildingSmart.IFC.IfcKernel
{
	...
	IFC4 CHANGE&nbsp;  The cardinality has been changed from 0:1 to 0:? with upward compatibility for file based exchange.
		...
		[Description(@"<EPM-HTML>
	Relation to the property set template, via the objectified relationship <em>IfcRelDefinesByTemplate</em>, that, if given, provides the definition template for the property set or quantity set and its properties. 
	<blockquote class=""change-ifc2x4"">
	IFC4 CHANGE&nbsp; New inverse relationship, change made with upward compatibility for file based exchange.
		...
		[Description(@"<EPM-HTML>
	Reference to the relation to one or many object occurrences that are characterized by the property set definition. A single property set can be assigned to multiple object occurrences using the objectified relationship <em>IfcRefDefinesByProperties</em>.
	<blockquote class=""change-ifc2x4"">
